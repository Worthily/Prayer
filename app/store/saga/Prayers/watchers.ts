...
export function* getPrayersWatchSaga() {
...
export function* createPrayerWatchSaga({
  payload,
...
export function* setPrayerCheckedWatchSaga({
  payload,
...
export function* deletePrayerWatchSaga({
  payload,
